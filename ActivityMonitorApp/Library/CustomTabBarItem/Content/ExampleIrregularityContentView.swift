...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        highlightIconColor = UIColor.white//init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        let dark_yellow = UIColor.init(red: 206.0/255, green: 158.0/255, blue: 29.0/255, alpha: 0.8)
        self.imageView.backgroundColor = UIColor.white//init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
        self.imageView.layer.borderWidth = 3.0
        self.imageView.layer.borderColor = UIColor.init(white: 235 / 255.0, alpha: 1.0).cgColor
        self.imageView.layer.cornerRadius = 30
        self.insets = UIEdgeInsetsMake(-27, 0, 0, 0)
        let transform = CGAffineTransform.identity
        self.imageView.transform = transform
        self.superview?.bringSubview(toFront: self)
        
        textColor = UIColor.init(white: 255.0 / 255.0, alpha: 1.0)
        highlightTextColor = dark_yellow
        iconColor = dark_yellow
        highlightIconColor = dark_yellow
        backdropColor = .clear
    ...
    public override func selectAnimation(animated: Bool, completion: (() -> ())?) {
        ...
        view.backgroundColor = UIColor.lightGray//init(red: 10/255.0, green: 66/255.0, blue: 91/255.0, alpha: 1.0)
    ...
    private func playMaskAnimation(animateView view: UIView, target: UIView, completion: (() -> ())?) {
        ...
        scale?.toValue = NSValue.init(cgSize: CGSize.init(width: 30.0, height: 30.0))
